...
function loaddata() {
    ...
    //$('<li>').append('<a href="javascript:contact()"  class="ui-btn ui-btn-icon-right ui-icon-user"  style="text-align:right"> من نحن </a> ').appendTo('#menudata');
...
function testuser() {
    try {
        ...
        $.ajax({
            type: "POST",
            url: "http://www.voicelenses.com/send/coding/login.ashx",
