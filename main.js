...
function show() {
    try {
        $.ajax({
            type: "POST",
            url: "http://www.voicelenses.com/send/coding/findid.ashx",
            data: {},
...
function getpost(mode, input, pid) {
    try {
        ...
        $.ajax({
            type: "POST",
            url: "http://www.voicelenses.com/send/coding/post.ashx",
...
function loadsection() {
    $.ajax({
        type: "POST",
        url: "http://www.voicelenses.com/send/coding/getsection.ashx",
        data: {},
        success: function (text) {
            try {
